...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.50.167.165:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#abiok9060-cicd-pipeline-alerts', //update and provide your channel name
